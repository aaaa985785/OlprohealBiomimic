...
<head>
    ...
    <title>歐承健股份有限公司-ourStrategy</title>
</head>
    ...
    <div class="wrap">
        ...
        <div class="meun" id="main">
            ...
            <ul>
                ...
                <!-- <li><a href="OPERATION.Our_Strategy&Directionshp echo $row['field2']; ?></a></li> -->
        ...
        <div class="business">
            <img src="./Our_Strategy&Directions/0001.jpg" alt="">
            <img src="./Our_Strategy&Directions/0002.jpg" alt="">
            <img src="./Our_Strategy&Directions/0003.jpg" alt="">
            <img src="./Our_Strategy&Directions/0004.jpg" alt="">
            <img src="./Our_Strategy&Directions/0005.jpg" alt="">
