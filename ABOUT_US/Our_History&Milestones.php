...
<head>
    ...
    <meta name="description"
        content="The Beginning of 歐承健 Olproheal It all started with a desire to improve the health of our aging family members..">

    <link rel="icon" href="../img/favicon.ico" type="image/x-icon" />

    <title>歐承健股份有限公司-ourHistory</title>
</head>
...
<body>
    ...
    <div id="myNav" class="overlay">
        ...
        <div class="overlay-content">
            ...
            <div class="dropdown-container">
                <a href="Our_History&Milestones.php">Our History & Milestones</a>
                <a href="Our_Essence.php">Our Essence</a>
                <a href="Our_Team.php">Our Teams</a>
            </div>
    ...
    <div class="wrap">
                ...
                <div class="dropdown">
                    <li style="cursor: pointer;">
                        ...
                        <div class="dropdown-content">
                            <a style="width: 160px;" href="Our_History&Milestones.php">Our History & Milestones</a>
                            <a style="width: 160px;" href="Our_Essence.php">Our Essence</a>
                            <a style="width: 160px;" href="Our_Team.php">Our Teams</a>
                    </li>
                </div>
                ...
                <div class="dropdown">
                    <li style="cursor: pointer;">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a style="width: 160px;" href="../OPERATION/Our_Competitive_Advantage.php">Our Competitive
                                Advantage</a>
                            <a style="width: 160px;" href="../OPERATION/Our_Strategy&Directions.php">Our Strategy &
                                Directions</a>
                    </li>
                </div>
                <div class="dropdown">
        ...
        <div class="business">
            <img src="./Our_History&Milestones/0001.jpg" alt="">
            <img src="./Our_History&Milestones/0002.jpg" alt="">
            <img src="./Our_History&Milestones/0003.jpg" alt="">
            <img src="./Our_History&Milestones/0004.jpg" alt="">
            <img src="./Our_History&Milestones/0005.jpg" alt="">
