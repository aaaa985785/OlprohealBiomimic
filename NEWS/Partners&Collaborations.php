...
<head>
    ...
    <title>歐承健股份有限公司-partners</title>
</head>
    ...
    <div id="myNav" class="overlay">
        ...
        <div class="overlay-content">
            ...
            <div class="dropdown-container">
                ...
                <a href="Partners&Collaborations.php">Partners & Collaborations</a>
            </div>
            <a href="">CONTACT US</a>
    ...
    <div class="wrap">
        ...
        <div class="meun" id="main">
            ...
            <ul>
                ...
                <!-- <li><a href="PRODUCTS.Orthopedic_Medical_deviceshp echo $row['field2']; ?></a></li> -->
                ...
                <div class="dropdown">
                    <li style="cursor: pointer;">
                        ...
                        <div class="dropdown-content">
                            <a style="width: 160px;" href="../PRODUCTS/Orthopedic_Medical_devices.php">Orthopedic Medical
                                devices</a>
                            <a style="width: 160px;" href="../PRODUCTS/Aesthetic_Medicine&Cell_Therapy.php">Aesthetic medicine &
                                Cell Therapy</a>
                    </li>
                </div>
                <div class="dropdown">
                    <li style="cursor: pointer;">
                        ...
                        <div class="dropdown-content">
                            ...
                            <a style="width: 160px;" href="Events.php">Events</a>
                            <a style="width: 160px;" href="Awards.php">Awards</a>
                            <a style="width: 160px;" href="Partners&Collaborations.php">Partners & Collaborations</a>
                    </li>
                </div>
        ...
        <div class="business">
            <img src="./Partners&Collaborations/0001.jpg" alt="">
            <img src="./Partners&Collaborations/0002.jpg" alt="">
            <img src="./Partners&Collaborations/0003.jpg" alt="">
            <!-- <img src="PRODUCTS/Orthopedic_Medical_devices/0004.jpg" alt="">
            <img src="PRODUCTS/Orthopedic_Medical_devices/0005.jpg" alt=""> -->
